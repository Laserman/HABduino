// Telemetry Added Version of Habduino
//
// Author 		Aykut Celik - http://picoballoon.ist/
//
...
//Telemetry Setup//
#define APRS_TELEM_INTERVAL 10 // Telemetry params set interval
...
#define APRS_COMMENT "your APRS Comment"
//APRS Comment//
...
void tx_aprs()
{
    ...
    ptr += 2;
    ax25_base91enc(ptr, 2, sats);
    ptr += 2;
    ax25_base91enc(ptr, 2,temperature1);
    ptr += 2;
    ax25_base91enc(ptr, 2,battvaverage);
